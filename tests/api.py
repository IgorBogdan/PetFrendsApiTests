...
class PetFrends:
    ...
    def create_pet(self, auth_key, name, animal_type,age):
        ...
        headers = {'auth_key': auth_key['key']}
        res = requests.post(self.base_url + '/api/create_pet_simple', headers=headers, params=data)
        status = res.status_code
        result = ""
        try:
            result = res.json()
